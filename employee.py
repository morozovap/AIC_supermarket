...
def add_employee(id_employee, surname, name, patronymic, role, salary, birth_date, start_date, phone, city, street, zip_code, login, plain_password):
    hashed_password = hash_password(plain_password)
    
    query = """
    INSERT INTO employee 
    (id_employee, empl_surname, empl_name, empl_patronymic, empl_role, salary, date_of_birth, date_of_start, phone_number, city, street, zip_code, login, password_hash)
    VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);
    """
    params = (id_employee, surname, name, patronymic, role, salary, birth_date, start_date, phone, city, street, zip_code, login, hashed_password)
...
def update_employee(id_employee, surname, name, patronymic, role, salary, birth_date, start_date, phone, city, street, zip_code, login):
    ...
    WHERE id_employee = %s;
    """
    params = (surname, name, patronymic, role, salary, birth_date, start_date, phone, city, street, zip_code, login, id_employee)
    execute_query(query, params)
...
if __name__ == '__main__':
    # Проста перевірка для себе, чи працює підключення
